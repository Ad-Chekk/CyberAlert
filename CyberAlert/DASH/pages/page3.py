...
def create_page_3(app):
    ...
    styles = {
        'gradient-background': {
            ...
            'padding': '20px',
            'display': 'flex',
            'flex-direction': 'column',  # Ensure proper stacking of navbar and content
        },
        'sidebar': {
            'padding': '20px',
            'background': 'linear-gradient(to right, #000000, #00000f, #00005f)',
        ...
        'content': {
            ...
            'gridGap': '20px',
            'marginTop': '20px',  # Add space below the navbar
        },
        'chart-container': {
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    dcc.Graph(id='status-code-pie'),
                                    dcc.Graph(id='response-time-hist'),
                                ],
                            ),
                        ],
                    ),
    ...
    def update_graphs(n_clicks, url):
        ...
        if n_clicks > 0 and url:
            ...
            fig_pie = px.pie(
                values=[30, 70], names=["Success", "Failure"], title="Example Pie Chart"
            )
            return fig_pie
        return px.pie()
